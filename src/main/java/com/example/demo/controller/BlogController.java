...
import com.example.demo.constants.BlogStatus;
import com.example.demo.constants.BlogpressConstants;
import com.example.demo.constants.CommentStatus;
...
public class BlogController {
	...
	public String addNewBlog(@RequestParam(value = "title",required = true) String title,
		...
		blog.setCreatedDate(BlogpressUtil.getFormattedDateForElasticSearch(new Date()));
		blog.setPublishDate(BlogpressUtil.getFormattedDateForElasticSearch(new Date()));
	...
	public String searchBlog(@RequestParam(value="searchText") String searchText, Model model){
		logger.info("Buscando para " + searchText);	
	...
	public String addComment(@RequestParam(value = "blogId",required = true) String blogId,
		...
		if(blogId !=null) {
			...
			if(blog !=null) {
				...
				blogComment.setCreatedDate(BlogpressUtil.getFormattedDateForElasticSearch(currentDate));
	...
	/**
	 * Este metodo evaluara si el usuario tiene un rol especifico
	 * @param roleName
	 * @return true or false - Si el usuario tiene el rol 
	 */
	...
	/**
	 * Este metodo evaluara si el usuario se ha logeado
	 * @return boolean Si usuario esta logeado
	 */
	...
	/**
	 * Este metodo devolvera el nombre del usuario actual
	 * @return
	 */
	...
	/**
	 * Este metodo almacena datos requeridos por la capa de presentación
	 * @param model
	 * @param pageTitle
	 */

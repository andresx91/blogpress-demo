...
public class BlogRepositoryCustomImpl implements BlogRepositoryCustom {
	...
	/**
	 * Este metodo devolvera la lista de blogs 
	 * para un texto de busqueda determinado
	 * La busqueda se realiza por titulo(title) y cuerpo(body) 
	 * 
	 * @param searchTxt
	...
	public List<Blog> search(String searchTxt){
		logger.info("Ejecutando busqueda para : " + searchTxt);
		...
		logger.info("Resultados : " + response.toString());
